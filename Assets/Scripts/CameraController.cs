...
public class CameraController : MonoBehaviour
{
    ...
    public float minX = -7.5f; // Minimum X boundary
    public float maxX = 7.5f;  // Maximum X boundary
    public float minZ = -7.5f; // Minimum Z boundary
    public float maxZ = 7.5f;  // Maximum Z boundary
